...
## How to setup
~~~
using BicUtil.InfinityMoney;
~~~

## How to use
- InfinityMoney(int _quantity, int _unit);
    - _quantity : 수량
    - _unit : 단위 1000^_unit , 1 = K, 2 = M, 3 = B, 4 = AA ...
    ~~~
    var _gold0 = new InfinityMoney(123, 0);  // 123
    var _gold1 = new InfinityMoney(9999, 0); // 9.999K (자동단위 변환)
    var _gold2 = new InfinityMoney(123, 1);  // 123K
    var _gold3 = new InfinityMoney(8880, 1); // 8.880M (자동단위 변환)
    ~~~
